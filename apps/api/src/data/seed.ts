...
export const seedGames: GameEntity[] = [
  ...
  },
  {
    ...
    slug: 'hero-journey',
    title: '용사의 여정',
    shortDescription: '기존 던전 4구간 이후 숲, 사막 협곡, 산길로 이어지는 저폴리 액션 RPG',
    description:
      '용사의 여정은 기존 던전 액션 구조를 유지하면서 야외 환경 에셋 스테이지를 확장한 저폴리 액션 RPG입니다. 입구 회랑, 무너진 채석장, 오래된 금고, 오크 대장 방을 돌파한 뒤 숲의 들머리, 사막 협곡, 바람산 고갯길로 이어지는 여정을 진행합니다.',
...
export const seedAdSlots: AdSlotConfig[] = [
  ...
  },
  {
    ...
    ...adProvider('', 'detail-mid-content', 'horizontal'),
    enabled: true,
    label: '게임 상세 스폰서',
    devices: ['desktop', 'mobile'],
    frequencyCap: { maxPerSession: 3 },
  },
  {
    ...
    page: 'game-list',
    position: 'in-feed',
    ...adProvider('', 'game-list-in-feed', 'horizontal'),
    enabled: true,
    label: '게임 목록 스폰서',
    devices: ['desktop', 'mobile'],
  ...
  },
  {
    ...
    page: 'game-play',
    position: 'bottom',
    ...adProvider('', 'play-bottom', 'horizontal'),
    enabled: true,
    label: '플레이 하단 스폰서',
    devices: ['desktop', 'mobile'],
    frequencyCap: { maxPerSession: 3 },
  ...
  },
  {
    ...
    page: 'global-ranking',
    position: 'mid-content',
    ...adProvider('', 'global-ranking-mid', 'horizontal'),
    enabled: true,
    label: '전체 랭킹 스폰서',
    devices: ['desktop', 'mobile'],
    frequencyCap: { maxPerSession: 4 },
