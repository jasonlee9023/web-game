  ...
  build: {
    rollupOptions: {
      input: {
        ...
        heroJourney: fileURLToPath(new URL('./games/hero-journey/index.html', import.meta.url)),
        dungeonQuestLegacy: fileURLToPath(new URL('./games/dungeon-quest/index.html', import.meta.url)),
